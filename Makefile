...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Fri Oct 16 11:25:42 2009
# Project:  qvv.pro
# Template: app
...
SOURCES       = qvv.cpp \
		qvv_main_win.cpp \
		qvv_view.cpp moc_qvv_main_win.cpp \
		moc_qvv_view.cpp \
		qrc_qvv.cpp
OBJECTS       = qvv.o \
		qvv_main_win.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qvv1.0.0/ && $(COPY_FILE) --parents qvv.h qvv_main_win.h qvv_view.h .tmp/qvv1.0.0/ && $(COPY_FILE) --parents qvv.qrc .tmp/qvv1.0.0/ && $(COPY_FILE) --parents qvv.cpp qvv_main_win.cpp qvv_view.cpp .tmp/qvv1.0.0/ && (cd `dirname .tmp/qvv1.0.0` && $(TAR) qvv1.0.0.tar qvv1.0.0 && $(COMPRESS) qvv1.0.0.tar) && $(MOVE) `dirname .tmp/qvv1.0.0`/qvv1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qvv1.0.0

...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Sun Oct 11 02:49:21 2009
# Project:  qvv.pro
# Template: app
...
LIBS          = $(SUBLIBS) -g -L/usr/lib64/qt/lib -lQtGui -L/usr/lib64/qt/lib -L/usr/X11R6/lib64 -pthread -lpng -lfreetype -lgobject-2.0 -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtCore -lz -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qvv1.0.0/ && $(COPY_FILE) --parents qvv.h .tmp/qvv1.0.0/ && $(COPY_FILE) --parents qvv.qrc .tmp/qvv1.0.0/ && $(COPY_FILE) --parents qvv.cpp qvv_main_win.cpp qvv_view.cpp .tmp/qvv1.0.0/ && (cd `dirname .tmp/qvv1.0.0` && $(TAR) qvv1.0.0.tar qvv1.0.0 && $(COMPRESS) qvv1.0.0.tar) && $(MOVE) `dirname .tmp/qvv1.0.0`/qvv1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qvv1.0.0
